#FROM jboss/wildfly
FROM quay.io/wildfly/wildfly:30.0.1.Final-jdk11
ENV WILDFLY_USER admin
ENV WILDFLY_PASS admin
ENV DS_NAME myDS
ENV DS_USER postgres
ENV DS_PASS postgres
ENV DS_URI jdbc:postgresql://dbpostgres/productos
...
ADD ProductosServidor/target/ProductosServidor.war ${JBOSS_HOME}/standalone/deployments
EXPOSE 8080
EXPOSE 8009
EXPOSE 9990
